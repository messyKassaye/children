...
public class SponsorInNeeds {
    ...
    public ArrayList<SponsorInNeed> show(SponsorInNeed sponsor) throws IOException {
        data=new ArrayList<>();
        String query = " select * from childrens c join sponsor_in_needs s on c.id = s.children_id "
        ...
        try {
            ...
            while (rs.next()) {
                ...
                inNeed.setAge(AgeCalculator.getAge(rs.getDate("birth_date")));
