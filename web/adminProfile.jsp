                                ...
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body" style="padding: 0px !important">
                                        <div class="list-group">
                                            <a class="list-group-item list-group-item-action" href="#" style="border: none !important;font-size: 17px;">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <img class="img-circle" width="50" height="50" src="resources/images/featured_child.jpg" alt="" style="margin-right: 5px;">Meseret Kassaye
                                                    </div>
                                                </div>
                                            </a>
                                            <a class="list-group-item list-group-item-action" href="#"  style="border: none !important;">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <img class="img-circle" src="http://placehold.it/45x45" alt="" style="margin-right: 5px;">Meseret Kassaye
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
