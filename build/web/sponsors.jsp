            ...
            <div class="col-md-6 col-lg-6 col-sm-12">
                ...
                <div class="row" style="word-spacing: -10px;margin-top: -10px;">
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <span class="glyphicon glyphicon-calendar"> <%=children.getBirthDate()%> years old</span>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <span class="glyphicon glyphicon-flag" style="text-align: center;" > <%=address.getCountry()%></span>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <span class="glyphicon glyphicon-tower" style="float: right;"> <%=address.getCity()%></span>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-lg-4 col-sm-12">                                    
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p class="main-p">
                            <strong>Age: </strong> <%=children.getBirthDate() + " years old"%>
                        </p>
                        <p class="main-p">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3>About <%=address.getCountry()%></h3>
                    </div>
